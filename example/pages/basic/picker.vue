<template>
  <div class="page-picker">
    <div class="page-picker-wrapper">
      <vs-picker :slots="yearSlot" @change="onYearChange" :visible-item-count="3"></vs-picker>
    </div>
    <p class="page-picker-desc">出生年份: {{ year }}</p>

    <div class="page-picker-wrapper">
      <vs-picker :slots="dateSlots" @change="onDateChange" :visible-item-count="3"></vs-picker>
    </div>
    <p class="page-picker-desc">在校时间: {{ dateStart }} 至 {{ dateEnd }}</p>

    <div class="page-picker-wrapper">
      <vs-picker :slots="addressSlots" @change="onAddressChange" :visible-item-count="5"></vs-picker>
    </div>
    <p class="page-picker-desc">地址: {{ addressProvince }} {{ addressCity }}</p>

    <!-- defaultIndex 参数变化 -->
    <div class="page-picker-wrapper">
      <vs-picker :slots="numberSlot" @change="onNumberChange" :visible-item-count="3"></vs-picker>
    </div>
